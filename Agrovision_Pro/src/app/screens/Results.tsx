...
export function Results() {
  ...
  const boxes = location.state?.boxes; // Array of mapped boxes
  ...
  const handleDownloadReport = async () => {
    ...
    toast.info('Generating your Smart PDF Report...');
    ...
    try {
      ...
      pdf.save(`Agrovision_Report_${disease.plant}_${disease.name}.pdf`);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Precision YOLOv8 Inference</p>
              </div>
            </div>
            <Button
              variant="ghost"
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-4 md:hidden z-30 shadow-lg">
          <div className="flex gap-2">
            ...
            <Button onClick={handleDownloadReport} disabled={isDownloading} className="flex-1 bg-[#2E7D32] hover:bg-[#1B5E20]">
        ...
        {/* Three-Zone Layout */}
        <div id="pdf-report-container" className="grid lg:grid-cols-12 gap-6 pb-24 md:pb-8 bg-gradient-to-br from-gray-50 to-gray-100 p-2 sm:p-4 rounded-xl">
            ...
            <Card className="sticky top-24 shadow-lg">
              ...
              <CardContent>
                ...
                <div className="relative rounded-lg overflow-hidden mb-4 group">
                  ...
                  {showBoundingBox && boxes && boxes.map((item: any, idx: number) => (
                    <div 
                      key={idx}
                      className="absolute border-4 border-[#2E7D32] rounded-lg shadow-[0_0_20px_rgba(46,125,50,0.6)] pointer-events-none"
                      style={{
                    ...
                    >
                      <div className="absolute -top-8 left-0 bg-[#2E7D32] text-white px-3 py-1 rounded text-sm font-medium whitespace-nowrap">
                        {item.mappedDisease.name} ({item.confidence}%)
                      </div>
                    </div>
                  ))}
                  {showBoundingBox && !boxes && (
                     <div className="absolute inset-[15%] border-4 border-dashed border-[#2E7D32] rounded-lg shadow-[0_0_20px_rgba(46,125,50,0.6)] pointer-events-none opacity-50">
                      <div className="absolute -top-8 left-0 bg-[#2E7D32] text-white px-3 py-1 rounded text-sm font-medium whitespace-nowrap">
                        Global Image Analysis (no box)
                      </div>
                    </div>
                  )}
